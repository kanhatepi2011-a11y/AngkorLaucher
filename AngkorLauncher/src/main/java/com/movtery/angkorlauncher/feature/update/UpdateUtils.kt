package com.movtery.angkorlauncher.feature.update
...
import com.movtery.angkorlauncher.feature.update.LauncherVersion.FileSize
import com.movtery.angkorlauncher.setting.AllSettings
import com.movtery.angkorlauncher.setting.AllSettings.Companion.ignoreUpdate
import com.movtery.angkorlauncher.task.TaskExecutors.Companion.runInUIThread
import com.movtery.angkorlauncher.ui.dialog.TipDialog
import com.movtery.angkorlauncher.ui.dialog.UpdateDialog
import com.movtery.angkorlauncher.utils.path.PathManager
import com.movtery.angkorlauncher.utils.ZHTools
import com.movtery.angkorlauncher.utils.http.CallUtils
import com.movtery.angkorlauncher.utils.http.CallUtils.CallbackListener
...
class UpdateUtils {
    companion object {
        ...
        fun getDownloadUrl(launcherVersion: LauncherVersion): String {
            ...
            return "https://github.com/AngkorLauncher/AngkorLauncher/releases/download/" +
                    "${launcherVersion.versionCode}/AngkorLauncher-${launcherVersion.versionName}" +
