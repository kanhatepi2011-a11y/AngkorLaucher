package com.movtery.angkorlauncher.feature.background
...
object BackgroundManager {
    ...
    fun setBackgroundImage(
        ...
        val defaultBackground = when (backgroundType) {
            // The Angkor scene belongs to launcher/editor surfaces only.
            BackgroundType.MAIN_MENU -> R.drawable.bg_angkor_wat
            BackgroundType.CUSTOM_CONTROLS -> R.drawable.bg_angkor_controls
            // Never put launcher artwork behind the live Minecraft renderer.
            BackgroundType.IN_GAME -> R.color.background_game
        }
        backgroundView.setImageDrawable(ContextCompat.getDrawable(context, defaultBackground))
