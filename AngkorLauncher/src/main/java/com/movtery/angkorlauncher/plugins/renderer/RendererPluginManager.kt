package com.movtery.angkorlauncher.plugins.renderer
...
/**
 * FCL、AngkorLauncher 渲染器插件，同时支持使用本地渲染器插件
    ...
    fun parseApkPlugin(context: Context, info: ApplicationInfo) {
        if (info.flags and ApplicationInfo.FLAG_SYSTEM == 0) {
            ...
            if (
                ...
                metaData.getBoolean("angkorRendererPlugin", false)
            ) {
