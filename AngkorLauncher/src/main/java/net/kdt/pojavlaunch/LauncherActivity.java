...
import static com.movtery.angkorlauncher.launch.LaunchGame.preLaunch;
...
import com.movtery.angkorlauncher.context.ContextExecutor;
import com.movtery.angkorlauncher.databinding.ActivityLauncherBinding;
import com.movtery.angkorlauncher.event.single.LaunchGameEvent;
import com.movtery.angkorlauncher.event.single.MainBackgroundChangeEvent;
import com.movtery.angkorlauncher.event.single.PageOpacityChangeEvent;
import com.movtery.angkorlauncher.event.single.SwapToLoginEvent;
import com.movtery.angkorlauncher.event.sticky.MinecraftVersionValueEvent;
import com.movtery.angkorlauncher.event.value.AddFragmentEvent;
import com.movtery.angkorlauncher.event.value.DownloadProgressKeyEvent;
import com.movtery.angkorlauncher.event.value.InstallGameEvent;
import com.movtery.angkorlauncher.event.value.InstallLocalModpackEvent;
import com.movtery.angkorlauncher.event.value.LocalLoginEvent;
import com.movtery.angkorlauncher.event.value.MicrosoftLoginEvent;
import com.movtery.angkorlauncher.event.value.OtherLoginEvent;
import com.movtery.angkorlauncher.feature.accounts.AccountType;
import com.movtery.angkorlauncher.feature.accounts.AccountsManager;
import com.movtery.angkorlauncher.feature.accounts.LocalAccountUtils;
import com.movtery.angkorlauncher.feature.background.BackgroundManager;
import com.movtery.angkorlauncher.feature.background.BackgroundType;
...
import com.movtery.angkorlauncher.feature.mod.modpack.install.InstallLocalModPack;
import com.movtery.angkorlauncher.feature.mod.modpack.install.ModPackInfo;
import com.movtery.angkorlauncher.feature.mod.modpack.install.ModPackUtils;
import com.movtery.angkorlauncher.feature.notice.CheckNewNotice;
import com.movtery.angkorlauncher.feature.notice.NoticeInfo;
import com.movtery.angkorlauncher.feature.update.UpdateUtils;
...
import com.movtery.angkorlauncher.feature.version.install.GameInstaller;
import com.movtery.angkorlauncher.feature.version.install.InstallTask;
import com.movtery.angkorlauncher.plugins.renderer.RendererPlugin;
import com.movtery.angkorlauncher.plugins.renderer.RendererPluginManager;
...
import com.movtery.angkorlauncher.ui.activity.BaseActivity;
import com.movtery.angkorlauncher.ui.activity.ErrorActivity;
import com.movtery.angkorlauncher.ui.dialog.EditTextDialog;
...
import com.movtery.angkorlauncher.ui.fragment.DownloadFragment;
import com.movtery.angkorlauncher.ui.fragment.DownloadModFragment;
import com.movtery.angkorlauncher.ui.fragment.SettingsFragment;
import com.movtery.angkorlauncher.ui.subassembly.settingsbutton.ButtonType;
import com.movtery.angkorlauncher.ui.subassembly.settingsbutton.SettingsButtonWrapper;
import com.movtery.angkorlauncher.ui.subassembly.view.DraggableViewWrapper;
...
import com.movtery.angkorlauncher.utils.stringutils.ShiftDirection;
...
public class LauncherActivity extends BaseActivity {
    ...
    private void processViews() {
        ...
        mSettingsButtonWrapper.setOnTypeChangeListener(type -> {
            ViewAnimUtils.setViewAnim(binding.settingButton, Animations.Pulse);
            binding.settingButton.setContentDescription(getString(
                    type == ButtonType.SETTINGS ? R.string.launcher_settings : R.string.launcher_home
            ));
        });
    ...
    private void refreshTopBarColor(boolean loadFromBackground) {
        // The hero artwork supplies the color. Keep this bar transparent and consistently legible.
        binding.topLayout.setBackgroundColor(Color.TRANSPARENT);
        int white = ContextCompat.getColor(this, R.color.launcher_text_primary);
        binding.appTitleText.setTextColor(white);
        binding.downloadButton.setImageTintList(android.content.res.ColorStateList.valueOf(white));
        binding.settingButton.setImageTintList(android.content.res.ColorStateList.valueOf(white));
    }

    private void applyLauncherInsets() {
        final int baseHeight = getResources().getDimensionPixelSize(R.dimen.launcher_top_bar_height);
        final int baseStart = binding.topLayout.getPaddingStart();
        final int baseEnd = binding.topLayout.getPaddingEnd();
        ...
        ViewCompat.setOnApplyWindowInsetsListener(binding.getRoot(), (view, windowInsets) -> {
            ...
            ViewGroup.LayoutParams topParams = binding.topLayout.getLayoutParams();
            topParams.height = baseHeight + safeInsets.top;
            binding.topLayout.setLayoutParams(topParams);
            binding.topLayout.setPaddingRelative(
                    baseStart + safeInsets.left,
                    safeInsets.top,
                    baseEnd + safeInsets.right,
                    0
            );
            binding.containerFragment.setPadding(safeInsets.left, 0, safeInsets.right, safeInsets.bottom);
            return windowInsets;
        });
