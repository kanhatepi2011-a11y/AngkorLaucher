...
import static com.movtery.angkorlauncher.utils.path.PathManager.DIR_NATIVE_LIB;
...
import com.movtery.angkorlauncher.renderer.RendererInterface;
...
public final class JREUtils {
    ...
    private static void setEnv(String jreHome, final Runtime runtime, Version gameVersion) throws Throwable {
        ...
        if (gameVersion != null) {
            ...
            envMap.put("ANGKOR_VERSION_CODE", String.valueOf(ZHTools.getVersionCode()));
        }
